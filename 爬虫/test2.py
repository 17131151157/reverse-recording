  ...
  <div class="header-inner">
        ...
        <div class="city-container" data-val="{currentcityid:50 }">
            ...
            <div class="city-list" data-val="{ localcityid: 50 }">
                <div class="city-list-header">定位城市：<a class="js-geo-city" data-ci="50">杭州</a></div>
            </div>
        </div>
...
<div class="content">
    <div class="wrapper">
        <div class="main">
            <p class="update-time">2025-03-25<span class="has-fresh-text">已更新</span></p>
...
<p class="score"><i class="integer">9.</i><i class="fraction">6</i></p>        
    ...
    <a href="/films/1297" title="肖申克的救赎" class="image-link" data-act="boarditem-click" data-val="{movieId:1297}">
      <img src="//s3.meituan.net/static-prod01/com.sankuai.movie.fe.mywww-files/image/loading_2.e3d934bf.png" alt="" class="poster-default" />
      <img data-src="https://p0.pipi.cn/mmdb/54ecde3311ef2abe12f0ee281b37b5fc0bc2b.jpg?imageView2/1/w/160/h/220" alt="肖申克的救赎" class="board-img" />
    </a>
    <div class="board-item-main">
      <div class="board-item-content">
              <div class="movie-item-info">
...
<p class="score"><i class="integer">9.</i><i class="fraction">5</i></p>        
    ...
    <a href="/films/1292" title="海上钢琴师" class="image-link" data-act="boarditem-click" data-val="{movieId:1292}">
      <img src="//s3.meituan.net/static-prod01/com.sankuai.movie.fe.mywww-files/image/loading_2.e3d934bf.png" alt="" class="poster-default" />
      <img data-src="https://p0.pipi.cn/mediaplus/friday_image_fe/cdf05c5cf87ea4f87bd8189dd2c5c8c208886.jpg?imageView2/1/w/160/h/220" alt="海上钢琴师" class="board-img" />
    </a>
    <div class="board-item-main">
      <div class="board-item-content">
              <div class="movie-item-info">
...
<p class="score"><i class="integer">9.</i><i class="fraction">3</i></p>        
    ...
    <a href="/films/4055" title="这个杀手不太冷" class="image-link" data-act="boarditem-click" data-val="{movieId:4055}">
      <img src="//s3.meituan.net/static-prod01/com.sankuai.movie.fe.mywww-files/image/loading_2.e3d934bf.png" alt="" class="poster-default" />
      <img data-src="https://p0.pipi.cn/mmdb/54ecde92339923b12d807750dae3398ce9cce.jpg?imageView2/1/w/160/h/220" alt="这个杀手不太冷" class="board-img" />
    </a>
    <div class="board-item-main">
      <div class="board-item-content">
              <div class="movie-item-info">
...
<p class="releasetime">上映时间：2024-11-01</p>    </div>
    <div class="movie-item-number score-num">
<p class="score"><i class="integer">9.</i><i class="fraction">6</i></p>        
    </div>
...
<p class="score"><i class="integer">9.</i><i class="fraction">3</i></p>        
    ...
    <a href="/films/416" title="盗梦空间" class="image-link" data-act="boarditem-click" data-val="{movieId:416}">
      <img src="//s3.meituan.net/static-prod01/com.sankuai.movie.fe.mywww-files/image/loading_2.e3d934bf.png" alt="" class="poster-default" />
      <img data-src="https://p0.pipi.cn/mmdb/fb7386510fa2ffd7c3e19bcb2e6ea4dc44460.jpg?imageView2/1/w/160/h/220" alt="盗梦空间" class="board-img" />
    </a>
    <div class="board-item-main">
      <div class="board-item-content">
              <div class="movie-item-info">
...
<div class="footer">
  ...
  <div class="certificate">
    ...
    <a href="/about/licence/5" target="_blank">
      <img src="https://p0.pipi.cn/rock/prod/common/image/066bfbe3d556ee42297264fd9dab4680.png?imageMogr2/thumbnail/2500x2500%3E" />
    </a>
    ...
    <script crossorigin="anonymous" src="//s3.meituan.net/mnpm-cdn/@mtfe-mt-apm-web-1.13.0/owl_1.13.0.min.js"></script>
    <script>
      Owl.start({
    ...
    <script src="//s0.pipi.cn/mediaplus/basic_tools_js/0.0.37_tool.js"></script>
    <script>
      window.MyH5Guard && MyH5Guard.start({ reportToRaptor: true });
    </script>
    <script src="//obj.pipi.cn/festatic/myas/0.0.1/WuKong.min.js"></script>
    <script>
      WuKong && WuKong.start({
        env: 'production'
      })
    ...
    <script crossorigin="anonymous" src="//s3.meituan.net/static-prod01/com.sankuai.movie.fe.mywww-files/common.9367ad28.js"></script>
<script crossorigin="anonymous" src="//s3.meituan.net/static-prod01/com.sankuai.movie.fe.mywww-files/board-index.4b26590f.js"></script>
...
regex = r'<div class="movie-item-info">.*?title="(.*?)".*?">.*?</a></p>.*?class="star">(.*?)</p>.*? class="releasetime">(.*?)</p>'
regexs = r'<div class="movie-item-info">.*?title="(.*?)".*?">.*?</a></p>.*?class="star">(.*?)</p>.*?class="releasetime">(.*?)</p>'
